...
*/
    ...
    private void fetchUserPosts() {
        ...
        try {
            ...
            String query = "SELECT "+ TableContent.TableContentClass.CONTENT_FILE + " , " + TableContent.TableContentClass.CONTENT_TITLE + " FROM " + tableName + " WHERE " + TableContent.TableContentClass.CONTENT_AUTHORID +" = "+userId;
